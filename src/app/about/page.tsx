            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-600">
                  ...
                  <p>
                    What started as a small studio with just a handful of members has grown into a thriving fitness community, but our core values remain the same – we're committed to providing personalised, effective training in a supportive, inclusive environment.
                  </p>
                </div>
              </div>
          ...
          <div className="container-custom">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <p className="text-white">
                These principles guide everything we do at TP Health & Fitness, from how we design our programmes to how we interact with our members.
              </p>
            </div>
