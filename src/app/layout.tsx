...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <meta httpEquiv="Content-Security-Policy" content="frame-src 'self' https://momence.com https://*.momence.com; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://momence.com https://*.momence.com;" />
