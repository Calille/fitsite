            ...
            {weekData.map((week) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className={`text-sm ${selectedWeek === week.week ? 'text-gray-600' : 'text-[#1a4a4e]'}`}>Week {week.week}</div>
                    <div className={`font-semibold ${selectedWeek === week.week ? 'text-gray-900' : 'text-[#1a4a4e]'}`}>{week.title}</div>
                  </div>
                </div>
              </motion.button>
            ))}
